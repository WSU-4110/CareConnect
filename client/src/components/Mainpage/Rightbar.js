            ...
            <div className="rightcontainer">
                <div className='adsContainer'>
                    ...
                    <div>
                        ...
                        <p style={{ textAlign: 'start', marginLeft: '10px', fontSize: "12px", marginTop: "-16px" }}>Feel happier with the help of a licensed counselor</p>
                    </div>
                </div>
                ...
                <div className='adsContainer'>
                    ...
                    <div>
                        ...
                        <p style={{ textAlign: 'start', marginLeft: '10px', fontSize: "12px", marginTop: "-16px" }}>Convenient and affordable therapy with BetterHelp</p>
                    </div>
                </div>
            </div>
